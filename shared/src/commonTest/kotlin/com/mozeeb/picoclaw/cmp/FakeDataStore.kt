...
/**
 * In-memory [AppSettings] for tests — stores values in a map.
 */
class FakeAppSettings : AppSettings {
    ...
    override suspend fun getInt(key: String, default: Int) = store[key] as? Int ?: default
    override suspend fun getBoolean(key: String, default: Boolean) = store[key] as? Boolean ?: default
